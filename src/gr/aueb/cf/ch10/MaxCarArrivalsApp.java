...
/**
 *  Program that has the time of arrival and departure of
 *  cars in a parking, and shows up the maximum car parked at the
 *  same time period.
 */
public class MaxCarArrivalsApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Max Car Arrivals: " + getMaxConcurrentCars(transformed));
    }
